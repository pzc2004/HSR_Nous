...
- **同人物多实体必须消歧**：SP 角色（姬子•启行≠姬子、丹恒•饮月/丹恒•腾荒≠丹恒、三月七 1001/1224 同名两实体、停云≠忘归人、开拓者按命途写如"开拓者·欢愉"）引用机制时必须全称或带 ID，不得简称；间隔号 • 在 阮•梅/千冶•刃 是名字本体（非 SP 标记），别误"纠正"；query skill 对同名查询报歧义+列候选
