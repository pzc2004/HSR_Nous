...
def test_anchor_ids_real_fixtures():
    ...
    assert anchor_ids() == frozenset({
        "1001", "1002", "1003", "1004", "1005", "1006", "1008", "1009", "1013", "1112", "1204", "1303", "1507", "1310", "1313", "1403", "1404", "1407", "1408", "1409", "1412",
        "1413", "1414", "1415",
...
def test_collect_targets_skips_anchors_by_default():
    ...
    assert "1013" not in t and "1014" in t, "1013 已转锚跳过；1014 仍在批"
