...
**能量来源建模**：回能按来源建模为 per-source 数据字段（基础值 + 是否吃 ERR + 归属）——普攻/战技/终结技为角色技能自带字段；受击回能为**敌人技能级** per-attack 字段；击杀回能分模式。**数值唯一来源**：`docs/mechanics/05_energy_system.md` §5.1，本章不复制。
